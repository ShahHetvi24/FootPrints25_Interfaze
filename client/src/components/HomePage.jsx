...
const HomePage = ({ darkMode, toggleDarkMode }) => {
  ...
  return (
    <div className="container dark:bg-[var(--dark-bg-color)] bg-[var(--bg-color)] mx-auto px-4 flex flex-col min-h-screen">
      <header className="py-6 flex justify-between items-center">
        ...
        >
          <div className="flex items-center">
            ...
            <h1 className="ml-2 text-2xl font-bold text-gray-800 dark:text-white">QuickMeet</h1>
          </div>
        </motion.div>
        <button 
          onClick={toggleDarkMode}
          className="p-2 rounded-full z-50 transition-colors focus:outline-none cursor-pointer"
        >
          {darkMode ? (
      ...
      <main className="flex-grow flex flex-col items-center justify-center -mt-20">
        ...
        >
          <h2 className="text-4xl font-bold mb-6 text-gray-800 dark:text-white">Welcome to QuickMeet</h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-12">Connect with teammates through simple, distraction-free video calls</p>
